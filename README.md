...
| --- | --- | --- |
| `VERSION` | `1.1.0` | Canonical Caustica version shared by the executable and wheel |
...
This writes `dist/caustica-1.1.0-windows-x64/` and
`dist/caustica-1.1.0-windows-x64.zip`. Use `--assets full` to include the complete
