...
void EnvMapImportanceSamplingBaker::CreateRenderPasses()
{
    ...
    {
        m_importanceMapComputeShader = m_shaderFactory->CreateShader("app/engine/Lighting/Distant/EnvMapImportanceSamplingBaker.hlsl", "BuildMIPDescentImportanceMapCS", nullptr, nvrhi::ShaderType::Compute);
...
#if 0
    {
        ...
        m_presamplingCS = m_shaderFactory->CreateShader("app/engine/Lighting/Distant/EnvMapImportanceSamplingBaker.hlsl", "PreSampleCS", nullptr, nvrhi::ShaderType::Compute);
...
int EnvMapImportanceSamplingBaker::GetImportanceMapResolution()
{
    return EMISB_IMPORTANCE_MAP_DIM;
}

int EnvMapImportanceSamplingBaker::GetImportanceMapMIPLevels()
{
...
void EnvMapImportanceSamplingBaker::Update(nvrhi::CommandListHandle commandList, nvrhi::TextureHandle sourceCubemap)
{
