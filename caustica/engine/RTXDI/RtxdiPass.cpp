...
void RtxdiPass::CreatePipelines(nvrhi::BindingLayoutHandle extraBindingLayout /*= nullptr*/, bool useRayQuery /*= true*/)
{
	...
	m_PresampleLightsPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PresampleLights.hlsl", "main", {}, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	m_PresampleEnvMapPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PresampleEnvironmentMap.hlsl", "main", {}, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	if (reGIRParams.Mode != rtxdi::ReGIRMode::Disabled)
	{
		m_PresampleReGIRPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PresampleReGIR.hlsl", "main", regirMacros, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	}
	
	m_GenerateInitialSamplesPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/GenerateInitialSamples.hlsl", 
		regirMacros, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	m_SpatialResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/SpatialResampling.hlsl",
		{}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	m_TemporalResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/TemporalResampling.hlsl",
		{}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	...
	m_FinalSamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/DIFinalShading.hlsl", "main", finalShadingMacros, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	
	m_GISpatialResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/GISpatialResampling.hlsl",
		{}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	m_GITemporalResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/GITemporalResampling.hlsl",
		{}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
	m_GIFinalShadingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/GIFinalShading.hlsl",
		{}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
    m_FusedDIGIFinalShadingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/FusedDIGIFinalShading.hlsl",
        {}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);

    m_PTGenerateInitialSamplesPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PTGenerateInitialSamples.hlsl",
        {}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
    m_PTTemporalResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PTTemporalResampling.hlsl",
        {}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
    m_PTSpatialResamplingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PTSpatialResampling.hlsl",
        {}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
    m_PTFinalShadingPass.Init(m_device, *m_shaderFactory, "app/engine/RTXDI/PTFinalShading.hlsl",
        {}, useRayQuery, RTXDI_SCREEN_SPACE_GROUP_SIZE, m_bindingLayout, extraBindingLayout, m_bindlessLayout);
}
