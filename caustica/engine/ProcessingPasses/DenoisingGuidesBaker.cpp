...
{ 
    ...
    m_csDenoiseSpecHitT.Init(m_device, *shaderFactory, "app/engine/ProcessingPasses/DenoisingGuidesBaker.hlsl", "DenoiseSpecHitT", std::vector<donut::engine::ShaderMacro>(), pipelineDesc.bindingLayouts);
    m_csComputeAvgLayerRadiance.Init(m_device, *shaderFactory, "app/engine/ProcessingPasses/DenoisingGuidesBaker.hlsl", "ComputeAvgLayerRadiance", std::vector<donut::engine::ShaderMacro>(), pipelineDesc.bindingLayouts);
    m_csDebugViz.Init(m_device, *shaderFactory, "app/engine/ProcessingPasses/DenoisingGuidesBaker.hlsl", "DebugViz", std::vector<donut::engine::ShaderMacro>(), pipelineDesc.bindingLayouts);
