    ...
    , m_FramebufferFactory(colorFramebufferFactory)
{
    ...
    {
        m_LuminanceShader = shaderFactory->CreateShader("app/engine/ToneMapper/luminance_ps.hlsl", "main", nullptr, nvrhi::ShaderType::Pixel);
        m_ToneMapShader = shaderFactory->CreateShader("app/engine/ToneMapper/ToneMapping.hlsl", "main_ps", nullptr, nvrhi::ShaderType::Pixel);
#if TONEMAPPING_AUTOEXPOSURE_CPU
        m_CaptureLuminanceShader = shaderFactory->CreateShader("app/engine/ToneMapper/ToneMapping.hlsl", "capture_cs", nullptr, nvrhi::ShaderType::Compute);
#endif
    }
