...
#define CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(TY)\
    inline bool operator==(TY a, TY b) { return a.bits == b.bits; } \
    inline bool operator!=(TY a, TY b) { return a.bits != b.bits; }
    
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float16_t)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float16_t2)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float16_t4)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float8e4m3_t)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float8e4m3_t4)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float8e5m2_t)
    CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS(float8e5m2_t4)

#undef CAUSTICA_MATH_DECLARE_EQUALITY_OPERATORS
