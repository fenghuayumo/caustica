...
// do not change generated code belong in StandardMaterialData, not here.
enum class MaterialFeature : materialFeatureMask
{
    ...
    // Reserved for future tier expansion. Disabled in the current bake path (#if 0 in StandardMaterial).
...
[[nodiscard]] materialFeatureMask computeMaterialFeatureMask(const StandardMaterial& material);
