...
caustica::rhi::VertexAttributeDesc caustica::getVertexAttributeDesc(VertexAttribute attribute, const char* name, uint32_t bufferIndex)
{
    caustica::rhi::VertexAttributeDesc result = {};
    result.name = name;
    ...
    case VertexAttribute::PrevPosition:
        result.format = caustica::rhi::Format::RGB32_FLOAT;
        result.elementStride = sizeof(float3);
        break;
    case VertexAttribute::TexCoord1:
    case VertexAttribute::TexCoord2:
        result.format = caustica::rhi::Format::RG32_FLOAT;
        result.elementStride = sizeof(float2);
        break;
    case VertexAttribute::Normal:
    case VertexAttribute::Tangent:
        result.format = caustica::rhi::Format::RGBA8_SNORM;
        result.elementStride = sizeof(uint32_t);
        break;
    case VertexAttribute::Transform:
        result.format = caustica::rhi::Format::RGBA32_FLOAT;
        result.arraySize = 3;
