...
class InstanceImpl {
    // Add denoisers here (Caustica keeps only DiffuseSpecular REBLUR/RELAX)
public:
    // Reblur
    void Add_ReblurDiffuseSpecular(DenoiserData& denoiserData);
    void Update_Reblur(const DenoiserData& denoiserData);
    void Update_ReblurOcclusion(const DenoiserData& denoiserData); // kept with shared Reblur.cpp helpers
