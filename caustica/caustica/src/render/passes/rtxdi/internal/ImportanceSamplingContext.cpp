...
#include "render/rtxdi/internal/GI/ReSTIRGI.h"
#include "render/rtxdi/internal/LightSampling/RISBufferSegmentAllocator.h"
#include "render/rtxdi/internal/ReGIR/ReGIR.h"
...
void debugCheckParameters(const caustica::rtxdi_internal::RISBufferSegmentParameters& localLightRISBufferParams,
                          const caustica::rtxdi_internal::RISBufferSegmentParameters& environmentLightRISBufferParams)
{
    ...
    m_lightBufferParams({})
{
    ...
    m_risBufferSegmentAllocator = std::make_unique<caustica::rtxdi_internal::RISBufferSegmentAllocator>();
    ...
    m_restirDIContext = std::make_unique<caustica::rtxdi_internal::ReSTIRDIContext>(restirDIStaticParams);

    m_regirContext = std::make_unique<caustica::rtxdi_internal::ReGIRContext>(isParams.regirStaticParams, *m_risBufferSegmentAllocator);
    ...
    m_restirGIContext = std::make_unique<caustica::rtxdi_internal::ReSTIRGIContext>(restirGIStaticParams);
}
