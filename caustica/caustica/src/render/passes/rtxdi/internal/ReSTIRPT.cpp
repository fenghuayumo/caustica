...
void ReSTIRPTContext::UpdateBufferIndices()
{
    ...
    {
    case caustica::rtxdi_internal::ReSTIRPT_ResamplingMode::None:
        m_bufferIndices.initialPathTracerOutputBufferIndex = 0;
        m_bufferIndices.finalShadingInputBufferIndex = 0;
        break;
    case caustica::rtxdi_internal::ReSTIRPT_ResamplingMode::Temporal:
        ...
        break;
    case caustica::rtxdi_internal::ReSTIRPT_ResamplingMode::Spatial:
        m_bufferIndices.initialPathTracerOutputBufferIndex = 0;
        ...
        break;
    case caustica::rtxdi_internal::ReSTIRPT_ResamplingMode::TemporalAndSpatial:
        m_bufferIndices.initialPathTracerOutputBufferIndex = 0;
