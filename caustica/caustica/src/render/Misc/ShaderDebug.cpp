...
void ShaderDebug::CreateRenderPasses( nvrhi::IFramebuffer * frameBuffer, nvrhi::TextureHandle depthBuffer )
{
    ...
    // debug triangles and lines...
    {
        ...
        m_trianglesVertexShader = m_shaderFactory->CreateShader("app/engine/shaders/Libraries/ShaderDebug/ShaderDebug.hlsl", "main_vs", &drawTrianglesMacro, nvrhi::ShaderType::Vertex);
        m_trianglesPixelShader = m_shaderFactory->CreateShader("app/engine/shaders/Libraries/ShaderDebug/ShaderDebug.hlsl", "main_ps", &drawTrianglesMacro, nvrhi::ShaderType::Pixel);
    }

    {
        std::vector<ShaderMacro> drawLinesMacro = { ShaderMacro("DRAW_LINES_SHADERS", "1") };
        m_linesVertexShader = m_shaderFactory->CreateShader("app/engine/shaders/Libraries/ShaderDebug/ShaderDebug.hlsl", "main_vs", &drawLinesMacro, nvrhi::ShaderType::Vertex);
        m_linesPixelShader = m_shaderFactory->CreateShader("app/engine/shaders/Libraries/ShaderDebug/ShaderDebug.hlsl", "main_ps", &drawLinesMacro, nvrhi::ShaderType::Pixel);
    }
