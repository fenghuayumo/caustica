    ...
    , m_CommonPasses(commonPasses)
{
    ...
    
    {
        ...
        m_Deinterleave.Shader = shaderFactory->CreateAutoShader("caustica/passes/ssao_deinterleave_cs.hlsl", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_ssao_deinterleave_cs), &macros, nvrhi::ShaderType::Compute);
...

    {
        ...
        m_Compute.Shader = shaderFactory->CreateAutoShader("caustica/passes/ssao_compute_cs.hlsl", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_ssao_compute_cs), &macros, nvrhi::ShaderType::Compute);
...

    {
        ...
        m_Blur.Shader = shaderFactory->CreateAutoShader("caustica/passes/ssao_blur_cs.hlsl", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_ssao_blur_cs), &macros, nvrhi::ShaderType::Compute);
