...
static sl::float4x4 make_sl_float4x4(const dm::float4x4& srcF4x4)
{
    ...
    outF4x4.setRow(1, make_sl_float4(srcF4x4.row1));
    outF4x4.setRow(2, make_sl_float4(srcF4x4.row2));
    outF4x4.setRow(3, make_sl_float4(srcF4x4.row3));
    return outF4x4;
}
...
void StreamlineIntegration::SetDLSSGOptions(const DLSSGOptions& options)
{
    ...
    slOptions.onErrorCallback = nullptr; // caustica does not expose this
