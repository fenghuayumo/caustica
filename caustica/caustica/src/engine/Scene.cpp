    ...
    , m_Device(device)
{
    ...
    m_SkinningShader = shaderFactory.CreateAutoShader("caustica/skinning_cs", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_skinning_cs), nullptr, nvrhi::ShaderType::Compute);
