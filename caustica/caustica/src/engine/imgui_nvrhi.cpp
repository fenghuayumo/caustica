...
bool ImGui_NVRHI::init(nvrhi::IDevice* device, std::shared_ptr<ShaderFactory> shaderFactory)
{
    ...
    vertexShader = shaderFactory->CreateAutoShader("caustica/imgui_vertex", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_imgui_vertex), nullptr, nvrhi::ShaderType::Vertex);
    pixelShader = shaderFactory->CreateAutoShader("caustica/imgui_pixel", "main", CAUSTICA_MAKE_PLATFORM_SHADER(g_imgui_pixel), nullptr, nvrhi::ShaderType::Pixel);
