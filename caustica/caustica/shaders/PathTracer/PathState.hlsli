...
enum class PathFlags
{
    ...
    transmissionEncountered        = (1<<21),  ///< Path has encountered a transmissive material. RTXCR uses this to constrain character SSS behind lenses/cornea.
...
enum class PackedCounters // each packed to 8 bits, 4 max fits in 32bit uint
{
    ...
    SubsurfaceEvents            = 3,    ///< RTXCR evaluates the spatial SSS branch at most once on each path.
};
